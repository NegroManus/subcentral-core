...
public class XRelLookup extends AbstractHttpHtmlLookup<MediaRelease, String>
{
	/**
	...
	@Override
	public LookupResult<MediaRelease> parseDocument(URL url, Document doc) throws Exception
	{
		return new XRelLookupResult(parseReleases(url, doc));
	}
