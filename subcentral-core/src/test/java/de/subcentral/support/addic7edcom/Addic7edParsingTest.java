...
public class Addic7edParsingTest
{
	...
	public void testEpisode01()
	{
		...
		SubtitleFile adj = new SubtitleFile(name, sub, rls);
	...
	public void testEpisode16()
	{
		...
		Subtitle sub = new Subtitle(epi, "English");
		sub.setSource("Addic7ed.com");
		SubtitleFile adj = new SubtitleFile(name, sub, ImmutableSet.of(rls1, rls2));
		adj.setTags(Tag.list("C", "orig"));
	...
	private static final void compare(String testMethodName, SubtitleFile expected, String nameToParse)
	{
