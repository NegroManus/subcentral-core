...
public class SubCentralDe
{
	...
	private static List<Parser<SubtitleVariant>> initParsers()
	{
		...
		ImmutableList.Builder<Parser<SubtitleVariant>> parsers = ImmutableList.builder();
	...
	private static List<MappingMatcherExtension> initExtensions()
	{
		...
		ext01.setPrefixProps(ImmutableList.of(SubtitleVariant.PROP_NAME));
		ext01.setPatternSuffix(")" + versionGrp + langGrp + "(?:" + groupGrp + ")?");
		ext01.setSuffixProps(ImmutableList.of(SubtitleVariant.PROP_VERSION, Subtitle.PROP_LANGUAGE, Subtitle.PROP_GROUP));
		...
		ext02.setPrefixProps(ImmutableList.of(SubtitleVariant.PROP_NAME));
		ext02.setPatternSuffix(")" + langGrp + versionGrp + "(?:" + groupGrp + ")?");
		ext02.setSuffixProps(ImmutableList.of(Subtitle.PROP_LANGUAGE, SubtitleVariant.PROP_VERSION, Subtitle.PROP_GROUP));
		...
		ext03.setPrefixProps(ImmutableList.of(SubtitleVariant.PROP_NAME));
		ext03.setPatternSuffix(")" + langGrp + groupGrp + "(?:" + versionGrp + ")?");
		ext03.setSuffixProps(ImmutableList.of(Subtitle.PROP_LANGUAGE, Subtitle.PROP_GROUP, SubtitleVariant.PROP_VERSION));
		extensions.add(ext03);

		// Language, (Group)?
		MappingMatcherExtension ext04 = new MappingMatcherExtension();
		ext04.setPatternPrefix("(");
		ext04.setPrefixProps(ImmutableList.of(SubtitleVariant.PROP_NAME));
		...
		ext05.setPrefixProps(ImmutableList.of(SubtitleVariant.PROP_NAME));
		ext05.setPatternSuffix(")" + versionGrp);
		ext05.setSuffixProps(ImmutableList.of(SubtitleVariant.PROP_VERSION));
