 ...
 * <li>All collection properties are final, never null and always mutable. With this knowledge, fewer helper collections have to be created. setter() methods exists but they invoke
 * <code>coll.clear(); coll.addAll()</code></li>
 * </ul>
 * 
