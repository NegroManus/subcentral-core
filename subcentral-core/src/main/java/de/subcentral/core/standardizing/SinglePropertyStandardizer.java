...
public abstract class SinglePropertyStandardizer<T, P> implements Standardizer<T>
{
    ...
    /**
     * If the property value is mutable, this methods needs to return a fresh copy, so that is not the same object as the one that will be modified
     * via {@link #setValue(Object, Object)}.
     * 
     * @param bean
