...
public class StandardAvMedia extends StandardMedia implements AvMedia
{
	...
	public static final SimplePropDescriptor	PROP_MEDIA_TYPE				= new SimplePropDescriptor(StandardAvMedia.class,
	...
	public static final SimplePropDescriptor	PROP_RUNNING_TIME			= new SimplePropDescriptor(StandardAvMedia.class,
	...
	public static final SimplePropDescriptor	PROP_DESCRIPTION			= new SimplePropDescriptor(StandardAvMedia.class,
																					PropNames.DESCRIPTION);
	public static final SimplePropDescriptor	PROP_COVER_URLS				= new SimplePropDescriptor(StandardAvMedia.class,
	...
	public static final SimplePropDescriptor	PROP_CONTRIBUTIONS			= new SimplePropDescriptor(StandardAvMedia.class,
	...
	public boolean equals(Object obj)
	{
		...
		if (obj != null && obj instanceof StandardAvMedia)
		{
