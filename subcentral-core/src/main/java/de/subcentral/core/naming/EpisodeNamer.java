...
public class EpisodeNamer extends AbstractPropertySequenceNamer<Episode>
{
    ...
    /**
     * The name of the parameter "preferSeriesTitle" of type {@link Boolean}. If set to {@code true}, the series title is preferred over its name. So the title is used if it is not {@code null}. The
    ...
    /**
     * The name of the parameter "alwaysIncludeSeasonTitle" of type {@link Boolean}. If set to {@code true}, the title of the episode's season is always included in the name, otherwise only if the
     * season is not numbered. The default value is {@code false}.
     */
