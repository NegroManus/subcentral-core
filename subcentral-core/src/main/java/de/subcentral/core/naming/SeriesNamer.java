...
{
    /**
     * The name of the parameter "name" of type {@link String}. The specified name is used for naming the series. The default value is the return
     * value of {@link Series#getName()}. But for example any alias name may be used.
     */
    public static final String PARAM_NAME = EpisodeNamer.class.getName() + ".name";
