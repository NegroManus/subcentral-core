...
public interface PropFromStringService
{
	...
	public default <P> List<P> parseList(Map<SimplePropDescriptor, String> info, SimplePropDescriptor propDescriptor, Class<P> elementClass) throws ParsingException
	{
