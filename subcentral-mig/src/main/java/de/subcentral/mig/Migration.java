...
public class Migration
{
	...
	public static final String	IMG_TYPE_SERIES_LOGO				= "seriesLogo";
	public static final String	IMG_TYPE_SEASON_HEADER				= "seasonHeader";
	public static final String	SEASON_ATTR_THREAD_ID				= "subcentralBoardId";
	public static final String	SERIES_ATTR_BOARD_ID				= "subcentralThreadId";
