...
public class Config
{
	...
	knownSubbers.add(Pattern.compile("(Randall Flagg|The old Man|JW 301|-TiLT- aka smizz|smizz aka -TiLT-|Kami Cat|Iulius Monea)", Pattern.CASE_INSENSITIVE));
	...
	standardizingService.registerStandardizer(Subber.class,
		new ReflectiveStandardizer<Subber, String>(Subber.class, "name", new PatternStringReplacer(Pattern.compile("(.*)\\."), "$1", PatternStringReplacer.Mode.REPLACE_COMPLETE)));
	standardizingService.registerStandardizer(Subber.class,
		new ReflectiveStandardizer<Subber, String>(Subber.class, "name", new StringReplacer("Ic3m4n", "Ic3m4n™", StringReplacer.Mode.REPLACE_COMPLETE)));
	standardizingService.registerStandardizer(Subber.class,
		new ReflectiveStandardizer<Subber, String>(Subber.class, "name", new StringReplacer("smizz aka -TiLT-", "-TiLT- aka smizz", StringReplacer.Mode.REPLACE_COMPLETE)));
