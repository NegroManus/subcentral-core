...
import de.subcentral.mig.process.SubCentralSubManDbApi;
...
public class SubCentralSubManDbApiTest
{
	...
	public void testInsertSeries() throws SQLException, ConfigurationException
	{
		...
		{
			SubCentralSubManDbApi api = new SubCentralSubManDbApi();
			api.setConnection(conn);
			api.insertSeriesFromSeriesList(series);

			System.out.println(series.getIds().get(SubCentralDe.SOURCE_ID));
