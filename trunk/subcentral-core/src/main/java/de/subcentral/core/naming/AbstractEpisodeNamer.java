...
public abstract class AbstractEpisodeNamer extends AbstractPropertySequenceNamer<Episode>
{
	...
	/**
	 * The name of the parameter "useSeriesTitle" of type {@link Boolean}. If set to {@code true}, the series title is used instead of its name. The
	 * default value is {@code false}.
	 */
	public static final String		PARAM_USE_SERIES_TITLE				= AbstractEpisodeNamer.class.getName() + ".useSeriesTitle";
	protected static final Boolean	PARAM_USE_SERIES_TITLE_DEFAULT		= Boolean.FALSE;
