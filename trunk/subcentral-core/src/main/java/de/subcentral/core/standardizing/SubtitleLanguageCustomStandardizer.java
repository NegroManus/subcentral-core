...
public class SubtitleLanguageCustomStandardizer implements Standardizer<Subtitle>
{
	private final Pattern	languagePattern;
	private final String	languageReplacement;

	public SubtitleLanguageCustomStandardizer(Pattern languagePattern, String languageReplacement)
	{
	...
	public boolean equals(Object obj)
	{
		...
		if (obj instanceof SubtitleLanguageCustomStandardizer)
		{
			SubtitleLanguageCustomStandardizer o = (SubtitleLanguageCustomStandardizer) obj;
