...
public class DirectoryWatchServicePlayground
{
	...
	service.registerDirectory(Paths.get("D:\\Downloads"), StandardWatchEventKinds.ENTRY_CREATE, StandardWatchEventKinds.ENTRY_DELETE, StandardWatchEventKinds.ENTRY_MODIFY);
	service.start();
