...
public abstract class StandardizerSettingEntry<T, S extends Standardizer<? super T>> extends AbstractSettingEntry<S>
{
    ...
    public StandardizerSettingEntry(Class<T> beanType, S standardizer, boolean beforeQuerying, boolean afterQuerying)
    {
	super(standardizer);
    ...
    public abstract StringBinding standardizerTypeStringBinding();
