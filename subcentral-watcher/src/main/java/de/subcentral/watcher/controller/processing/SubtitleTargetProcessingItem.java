				...
				switch (info.getMethod())
				{
					...
					case GUESSING:
					{
						...
						if (pInfo.getStandardRelease() != null)
						{
							...
							sb.append(SubtitleTargetProcessingItem.this.namingService.name(pInfo.getStandardRelease().getRelease(),
									SubtitleTargetProcessingItem.this.namingParameters));
							sb.append(")");
						}
						return sb.toString();
					}
					case COMPATIBILITY:
					{
						...
						sb.append(SubtitleTargetProcessingItem.this.namingService.name(cInfo.getCompatibilityInfo().getCompatibleTo(),
								SubtitleTargetProcessingItem.this.namingParameters));
